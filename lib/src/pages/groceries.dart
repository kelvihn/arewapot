...
class Grocery extends StatefulWidget {
  ...
  Grocery({Key key, this.routeArgument}) : super(key: key);

  @override
  _GroceryState createState() => _GroceryState();
}

class _GroceryState extends StateMVC<Grocery> {
  // TODO add layout in configuration file
  String layout = 'grid';

  GroceryController _con;

  _GroceryState() : super(GroceryController()) {
    _con = controller;
  }
